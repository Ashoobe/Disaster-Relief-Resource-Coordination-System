    ...
    <div className="users-page">
      <div className="users-header">
        <div className="users-title">
          ...
          <p>Manage system users. The current backend supports volunteer account creation and user deletion.</p>
        </div>
        <button
                ...
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td className="text-muted" data-label="Last Login">{formatDate(user.lastLogin)}</td>
                      <td data-label="Actions">
                        <div className="user-actions">
                          <button
                            ...
                            disabled
                            title="Role changes are not available in the current backend"
                          ...
                          <button
                            ...
                            disabled
                            title="Status toggle is not available in the current backend"
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleAddUser}>
              <div className="modal-body">
                ...
                <small className="text-muted">The current backend register endpoint creates volunteer accounts only.</small>
              </div>
