      ...
      <main className="tracking-main">
        <section className="tracking-hero">
          <div className="tracking-hero-content">
            ...
            <p>
              Enter the tracking code from your confirmation message to check your request status.
            </p>
            ...
            <form className="tracking-form" onSubmit={handleTrack} noValidate>
              <div className="tracking-input-row">
                <input
                  ...
                  placeholder="e.g. DISASTER-2026-AB12CD34"
                  value={query}
            ...
            <div className="tracking-hints">
              ...
              <ul>
                <li><strong>Tracking code</strong> - shown on your confirmation screen (for example <code>DISASTER-2026-AB12CD34</code>)</li>
              </ul>
            </div>
          </div>
        </section>
