            ...
            {visibleFocusAreas.length > 0 && (
              <div className="live-focus-areas">
                <div className="live-focus-heading">
                  <span className="live-focus-icon" aria-hidden="true"><MapPin size={15} /></span>
                  <div>
                    <strong>Top Focus Areas</strong>
                    <span className="live-focus-subtitle">{focusAreas.length} NOAA alert areas</span>
                  </div>
                </div>
                <div className="live-focus-tags">
                  {visibleFocusAreas.map((area, index) => (
                    <span key={area} className="live-focus-tag" title={area}>
                      <span className="live-focus-rank">{index + 1}</span>
                      <span className="live-focus-tag-label">{area}</span>
                    </span>
                  ))}
