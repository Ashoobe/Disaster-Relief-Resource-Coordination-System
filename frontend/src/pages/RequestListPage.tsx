                ...
                {filteredRequests.length === 0 ? (
                  ...
                  filteredRequests.map((request) => (
                    <TableRow key={request.id} className="hover:bg-gray-50">
                      <TableCell className="font-mono" data-label="Tracking Code">{request.trackingCode || request.id}</TableCell>
                      <TableCell data-label="Disaster Type">
                        <div className="disaster-cell">
                          {getDisasterIcon(request.disasterType)}
                          <span>{request.disasterType}</span>
                        </div>
                      </TableCell>
                      <TableCell className="request-category-cell" data-label="Category">{request.category}</TableCell>
                      ...
                      <TableCell className="truncate" data-label="Location">{request.location.address}</TableCell>
                      ...
                      <TableCell className="request-time-cell" data-label="Time">{format(new Date(request.timestamp), 'MMM dd, HH:mm')}</TableCell>
                      <TableCell className="request-action-cell" data-label="Actions">
                        <Button asChild variant="ghost" size="sm">
                          <Link to={`/requests/${request.id}`} className="request-action-link">View</Link>
                        </Button>
                      </TableCell>
                    </TableRow>
                  ))
