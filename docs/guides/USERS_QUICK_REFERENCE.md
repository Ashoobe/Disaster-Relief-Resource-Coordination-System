...
### Files Created
```
frontend/src/services/userService.js          - User CRUD operations
frontend/src/components/users/UsersPage.jsx   - Main UI component
frontend/src/components/users/UsersPage.css   - Styling
```

### Files Modified
```
frontend/src/App.jsx                       - Users route lives in the main router
frontend/src/components/layout/Sidebar.jsx - Updated Users link
```
